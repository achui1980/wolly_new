...
public interface CotFinanceGivenService {
	...
	// 保存或者更新付款记录
	public Integer saveOrUpdateRecv(CotFinacegiven cotFinacerecv, String finaceRecvDate);
...
//	public String createFinaceNo(Integer factoryId);
	...
	//flag=0为可以删除,1为溢付款转到出货,2为预收货款有金额流到出货
