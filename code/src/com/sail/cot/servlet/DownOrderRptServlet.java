...
public class DownOrderRptServlet extends javax.servlet.http.HttpServlet
	...
	private void downFile(HttpServletRequest request,
		...
		if ("PDF".equals(printType)) {
			...
			String rptPath = SystemUtil.getRptFilePath()+"/order/PI-"+ orderNo+".pdf";
			if(customPdf == null){
		...
		if ("HTML".equals(printType)) {
			...
			this.setFileDownloadResponseHeader(response, orderNo+".html");
			exporter
					.setParameter(JRExporterParameter.JASPER_PRINT, jasperPrint);
