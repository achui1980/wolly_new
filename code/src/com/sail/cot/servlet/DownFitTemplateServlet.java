...
public class DownFitTemplateServlet extends HttpServlet implements Servlet {

	private void downEleTemplate(HttpServletRequest request,
			HttpServletResponse response) throws IOException {
		// 设置下载头
		setDownloadResponseHeader(response, "fitting.xls");
		// 要导出的样品模板文件
		String filePath = "reportfile/fitting.xls";
		// 获得tomcat路径
