...
public class DownOrderOutRptServlet extends javax.servlet.http.HttpServlet
	...
	private void downFile(HttpServletRequest request,
		...
		if ("PDF".equals(printType)) {
			try {
//				String rptPath = SystemUtil.getRptFilePath() + "/orderout/"
//						+ orderOutNo + ".pdf";
				...
				//			
				//			File file = new File(SystemUtil.getRptFilePath()+"orderout");
				//			if (!file.exists()) {
				//				file.mkdirs();
				//			}
				//			
				//			System.out.println( SystemUtil.getRptFilePath());
				//			String rptPath = SystemUtil.getRptFilePath()+"/orderout/"+ orderOutNo+".pdf";
