...
public class DownPrsServlet extends javax.servlet.http.HttpServlet
...
//		String priceNo = request.getParameter("priceNo");
		String priceNo = "Wolly&Co. Quotation";
		if(headerFlag == null)
			headerFlag = "false";
		...
		String facId = request.getParameter("facId");// 厂家
		String fileName = "询盘单";
		if (gId != null && !gId.trim().equals("")) {
			queryString.append(" and p.id=" + gId);
		}else{
			return;
		}
