...
public class DownChkRptServlet extends HttpServlet implements Servlet {

	private void downRpt(HttpServletRequest request,
			HttpServletResponse response) throws IOException {
		
		String orderNo = request.getParameter("orderNo");// 单号
		String type = request.getParameter("type");// 单号
		// 设置下载头
		setDownloadResponseHeader(response, orderNo+".pdf");
		// 要导出的样品模板文件
		String filePath = "saverptfile/"+type+"/"+orderNo+".pdf";
		// 获得tomcat路径
