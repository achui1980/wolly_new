...
public class DownOrderPictureServlet extends javax.servlet.http.HttpServlet
...
//		String orderNo = request.getParameter("orderNo");
		...
		String gId = request.getParameter("orPicId");// 主包材采购单
		String facFlag = request.getParameter("facFlag");// 判断是不是po
		String fileName = "Packing_Instruction-PI";
		if (gId != null && !gId.trim().equals("")) {
			queryString.append(" and obj.id=" + gId);
		}else{
			return;
		}
		
		if (facFlag != null) {
			fileName = "Packing_Instruction-PO";
		}
