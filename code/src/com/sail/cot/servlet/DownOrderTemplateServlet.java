...
public class DownOrderTemplateServlet extends HttpServlet implements Servlet {

	private void downEleTemplate(HttpServletRequest request,
			HttpServletResponse response) throws IOException {
		// 设置下载头
		setDownloadResponseHeader(response, "excel.xls");
		String flag = request.getParameter("flag");
		// 要导出的样品模板文件
		String filePath = "reportfile/orderExcel.xls";//订单
		if(flag!=null && flag.equals("orderout")){
			filePath = "reportfile/outExcel.xls";//出货
		}
		if(flag!=null && flag.equals("given")){
			filePath = "reportfile/givenExcel.xls";//寄样
		}
		// 获得tomcat路径
		String classPath = DownEleTemplateServlet.class.getResource("/")
				.toString();
