...
public class DownPanServlet extends javax.servlet.http.HttpServlet
...
//		String priceNo = request.getParameter("priceNo");
		String priceNo = "Inquiry";
		if(headerFlag == null)
			headerFlag = "false";
		StringBuffer queryString = new StringBuffer();
		queryString.append(" 1=1");
		
		String gId = request.getParameter("panId");// 主包材采购单
		String fileName = "询盘单";
		if (gId != null && !gId.trim().equals("")) {
			queryString.append(" and obj.panId=" + gId);
		}else{
			return;
		}
...
//		String detailIds = request.getParameter("detailIds");// 询盘单编辑页面勾选的明细ids
...
//			this.setFileDownloadResponseHeader(response, orderNo+".xls");
	...
	public static String encodingFileName(String fileName) {
        ...
        try {
            ...
            //替代 "%26" 为 "&"
            returnFileName=returnFileName.replace("%26", "&");
