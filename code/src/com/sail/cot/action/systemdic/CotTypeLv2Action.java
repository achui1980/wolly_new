 ...
 * 
 */
public class CotTypeLv2Action extends AbstractAction {
	...
	public ActionForward query(ActionMapping mapping, ActionForm form,
		...
		// 设置查询记录总数语句
		queryInfo.setCountQuery("select count(*) from CotTypeLv2 obj "
				+ sql.toString());
		// 设置查询记录语句
		queryInfo.setSelectString("from CotTypeLv2 obj ");
		// 设置条件语句
