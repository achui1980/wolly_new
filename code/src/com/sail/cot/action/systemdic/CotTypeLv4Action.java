 ...
 * 
 */
public class CotTypeLv4Action extends AbstractAction {
	...
	public ActionForward query(ActionMapping mapping, ActionForm form,
		...
		// 设置查询记录总数语句
		queryInfo.setCountQuery("select count(*) from CotTypeLv4 obj "
				+ sql.toString());
		// 设置查询记录语句
		queryInfo.setSelectString("from CotTypeLv4 obj ");
		// 设置条件语句
