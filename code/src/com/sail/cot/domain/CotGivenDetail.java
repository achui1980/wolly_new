...
/**
 * CotGivenDetail entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class CotGivenDetail implements java.io.Serializable {
	...
	/** default constructor */
	public CotGivenDetail() {
	}

	/** full constructor */
	public CotGivenDetail(String eleParent, String eleId, String eleName,
			...
			Float priceFac, Float priceOut, String signRequire, Date addTime,
			String addPerson, Integer givenId, Integer factoryId,
			Integer eleTypeidLv1, Integer eleHsid, Integer priceFacUint,
			Integer priceOutUint, Integer boxTypeId, Integer givenCount) {
	...
	public Float getGivenPrice() {
		return givenPrice;
	}

	public void setGivenPrice(Float givenPrice) {
	...
	public String getEleSignCyc() {
		return eleSignCyc;
	}

	public void setEleSignCyc(String eleSignCyc) {
		this.eleSignCyc = eleSignCyc;
	}
