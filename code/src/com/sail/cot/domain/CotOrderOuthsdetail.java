...
/**
 * CotOrderOuthsdetail entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class CotOrderOuthsdetail implements java.io.Serializable {
	...
	// Constructors
	/** default constructor */
	public CotOrderOuthsdetail() {
	}

	/** full constructor */
	public CotOrderOuthsdetail(CotOrderOut cotOrderOut, String eleId,
			...
			String custNo, String factoryNo, Float orderPrice) {
		this.eleId = eleId;
