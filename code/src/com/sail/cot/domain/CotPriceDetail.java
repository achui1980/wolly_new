...
/**
 * CotPriceDetail entity.
 * 
 * @author MyEclipse Persistence Tools
 */

public class CotPriceDetail implements java.io.Serializable {
	...
	public Float getPricePrice() {
		pricePrice = new Float(ContextUtil.getObjByPrecision(pricePrice, "orderPricePrecision"));
		return pricePrice;
	}
