...
public class CotOrderOut implements java.io.Serializable {
	...
	private Double cutScale;//--利润率
	private Double commisionScale;//---佣金
	...
	private Set cotOrderOutdetails = new HashSet(0);
	private Set cotOrderOuthsdetails = new HashSet(0);
	private Set cotSplitInfos = new HashSet(0);
	private Set cotHsInfos = new HashSet(0);
	private Set cotShipments = new HashSet(0);
	private Set cotSymbols = new HashSet(0);
	private Set cotOrderouthsRpt = new HashSet(0);
	...
	/** minimal constructor */
	public CotOrderOut(String orderNo, Long orderStatus, Long orderIscheck) {
	...
	/** full constructor */
	public CotOrderOut(Integer empId, String orderNo, Date orderTime,
		...
		this.cotOrderOutdetails = cotOrderOutdetails;
		this.cotSplitInfos = cotSplitInfos;
		this.cotHsInfos = cotHsInfos;
		this.cotShipments = cotShipments;
		this.cotSymbols = cotSymbols;
	}
	...
	public Set getCotOrderOutdetails() {
		return this.cotOrderOutdetails;
	}

	public void setCotOrderOutdetails(Set cotOrderOutdetails) {
		this.cotOrderOutdetails = cotOrderOutdetails;
	}

	public Set getCotSplitInfos() {
		return this.cotSplitInfos;
	}

	public void setCotSplitInfos(Set cotSplitInfos) {
		this.cotSplitInfos = cotSplitInfos;
	}

	public Set getCotHsInfos() {
		return this.cotHsInfos;
	}

	public void setCotHsInfos(Set cotHsInfos) {
		this.cotHsInfos = cotHsInfos;
	}

	public Set getCotShipments() {
		return this.cotShipments;
	}

	public void setCotShipments(Set cotShipments) {
		this.cotShipments = cotShipments;
	}

	public Set getCotSymbols() {
		return this.cotSymbols;
	}

	public void setCotSymbols(Set cotSymbols) {
		this.cotSymbols = cotSymbols;
	}
	...
	public Set getCotOrderOuthsdetails() {
		return cotOrderOuthsdetails;
	}

	public void setCotOrderOuthsdetails(Set cotOrderOuthsdetails) {
		this.cotOrderOuthsdetails = cotOrderOuthsdetails;
	}
	...
	public Set getCotOrderouthsRpt() {
		return cotOrderouthsRpt;
	}

	public void setCotOrderouthsRpt(Set cotOrderouthsRpt) {
		this.cotOrderouthsRpt = cotOrderouthsRpt;
	}
