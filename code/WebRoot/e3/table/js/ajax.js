...
AjaxAnywhere.prototype.doSubmitAJAX = function(additionalPostData,params, submitButton) {
    ...
    var postData = "";
    postData = "&aaxmlrequest=true";
    for(var p in params)
    {
    	postData += "&"+p+"="+params[p];
    }
    if (zones != "")
        postData = '&aazones=' + zones + "&" + postData + "&" + additionalPostData;
    else
        postData += "&" + additionalPostData;
	//alert(postData);
    this.sendPreparedRequest(postData);
