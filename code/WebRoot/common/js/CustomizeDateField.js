CustomizeField = Ext.extend(Ext.form.TwinTriggerField,  {
    /**
     * @cfg {String} format
...
disabledDates: ["^03"]
    ...
    initComponent : function(){
       CustomizeField.superclass.initComponent.call(this);
    ...
    initEvents: function() {
        CustomizeField.superclass.initEvents.call(this);
    ...
    getErrors: function(value) {
        var errors = CustomizeField.superclass.getErrors.apply(this, arguments);
     ...
     */
    getValue : function(){
        return this.parseDate(CustomizeField.superclass.getValue.call(this)) || "";
    },
...
dateField.setValue('2006-05-04');
    ...
    setValue : function(date){
        return CustomizeField.superclass.setValue.call(this, this.formatDate(this.parseDate(date)));
    },
    ...
    onDestroy : function(){
        ...
        CustomizeField.superclass.onDestroy.call(this);
    },
...
Ext.reg('cdatefield', CustomizeField);