...
/*
 * 
 * @class Ext.ux.form.MyFileUploadField
 * @extends Ext.form.TwinTriggerField
 * Ext.ux.form.MyFileUploadField
 *
 * examples like this :
 *
 *{
...
Ext.ux.form.MyFileUploadField = Ext.extend(Ext.form.TwinTriggerField, {
    ...
    initComponent : function(){
        Ext.ux.form.MyFileUploadField.superclass.initComponent.call(this);
		...
		this.triggerConfig = {
            ...
            {tag:'span', cls:'ux-cabinet', cn:[
            	{tag: "div", id:'wrap'+this.fileFieldId,cls:"ux-input-file-wrapper",cn: [
                    {tag: "input", name: this.fileFieldName, cls : 'ux-file',type: "file", id: this.fileFieldId}
                ]},
		...
		this.addEvents(
             ...
             * @param {Ext.ux.form.MyFileUploadField} this
             ...
             * @param {Ext.ux.form.MyFileUploadField}
	...
	onRender : function(ct, position){
		Ext.ux.form.MyFileUploadField.superclass.onRender.call(this,ct,position);
	...
	//init events
    initEvents : function(){
		Ext.ux.form.MyFileUploadField.superclass.initEvents.call(this);
	...
	//override
    reset : function(){
        Ext.ux.form.MyFileUploadField.superclass.reset.call(this);
        if(this.fileField){
			this.clearValue();
		}
    },
    ...
    // private
    onDestroy: function(){
        Ext.ux.form.MyFileUploadField.superclass.onDestroy.call(this);
        Ext.destroy(this.fileField, this.fileFieldWrap);
    },
    
    onDisable: function(){
        Ext.ux.form.MyFileUploadField.superclass.onDisable.call(this);
        this.doDisable(true);
    },
	
	onEnable: function(){
        Ext.ux.form.MyFileUploadField.superclass.onEnable.call(this);
...
Ext.reg('myfileuploadfield', Ext.ux.form.MyFileUploadField);