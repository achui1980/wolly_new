...
<html>
  <head>
    ...
    <script type="text/javascript" src="dwr/interface/mailTreeService.js"></script>
    ...
    <script type="text/javascript" src="mail/inbox/js/inbox.js"></script>
  ...
  <body>
  	...
  	<input type="hidden" id="newMsgEmpId" value='<%= request.getParameter("newMsgEmpId")%>'>
