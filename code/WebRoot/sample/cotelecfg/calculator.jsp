												...
												<td>
													<table width="100%" border=0>
														...
														<tr>
															...
															<td colspan=2>
																<input type="button" class="blue" style="width: 70px"
																value="Close" onClick="javascript:parent.closeCal(0);">
															</td>
														</tr>
													</table>
												</td>
														...
														<tr>
															<td>
																<select  id="baseField" name="baseField" size="10" 
																	...
																	<option value="priceFac">Purchage Price</option>
																	<option value="priceRate"> Rate </option>
																	<option value="priceProfit"> Profit</option>
																	<!--<option value="tuiLv">Tax rate</option>-->
																	<!--<option value="cbm">CBM</option>
																	<option value="boxObCount">Packing</option>-->
																</select>
															</td>
														</tr>
													</table>
