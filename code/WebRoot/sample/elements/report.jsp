      ...
      <td>       
        ...
        <%
          ...
          else
          {
            ...
            %>
            <label>当前第<%=pageIndex+1%>/<%=lastPageIndex%>页,</label>
            <label>跳转到第</label>
...
<div id="noData" style="display: none;position:absolute;"><H3>目前没有任何样品数据！<a href="#" onclick="javascript:window.close();">关闭</a></H3></div>
