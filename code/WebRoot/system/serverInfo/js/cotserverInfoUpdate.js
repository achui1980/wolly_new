...
//					//alert(record.data.id)
		...
		},
		{
			...
			allowNegative :false,
			decimalPrecision :0,
			emptyText:"Please enter the number of clients,Value range (up type - Temporary：【1-15】,Permanent: Unlimited)",
			allowBlank:false,
		...
		},
		{
	    	...
	    	items: [
		        {boxLabel: 'Mail', name: 'emailmodule',id:'emailmodule' ,inputValue:"A"}
		    ]
		},
		{
			xtype:"panel",
