...
//					//alert(record.data.id)
		...
		},
		{
			...
			allowNegative :false,
			decimalPrecision :0,
			emptyText:"Please enter the number of clients, the value range (up type - Temporary:【1-15】,Permanent: Unlimited)",
			allowBlank:false,
		...
		},
		{
	    	...
	    	items: [
		        {boxLabel: '邮件', name: 'emailmodule',id:'emailmodule' ,inputValue:"A"}
		    ]
