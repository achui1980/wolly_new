...
OrderPackGrid = function(cfg) {
	...
	var ds = new Ext.data.Store({
				proxy : new Ext.data.HttpProxy({
							url : "cotorderout.do?method=queryPackOrderByFinace&orderOutId="+parent.$('pId').value
						}),
	...
	Ext.apply(con, cfg);
	OrderPackGrid.superclass.constructor.call(this, con);
};
Ext.extend(OrderPackGrid, Ext.Panel, {});
