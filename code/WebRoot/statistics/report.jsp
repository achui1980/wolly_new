...
function changePage(value){
	window.location.reload('<%=webapp %>/cotstatistics.do?method=queryRptByArea&queryAgain=false&pageIndex='+value);
}
//本地打印
	...
	<tr>
      <td>       
        ...
        <%
          ...
          {
            %>
            <a href="<%=webapp %>/cotstatistics.do?method=queryRptByArea&queryAgain=false&pageIndex=0"><img src="<%=webapp %>/common/images/first.gif" alt="第一页" border="0"></a>
            <a href="<%=webapp %>/cotstatistics.do?method=queryRptByArea&queryAgain=false&pageIndex=<%=pageIndex - 1%>"><img src="<%=webapp %>/common/images/previous.gif" alt="上一页" border="0"/></a>
            <%
          }
          else
          {
          ...
          {
            %>
            <a href="<%=webapp %>/cotstatistics.do?method=queryRptByArea&queryAgain=false&pageIndex=<%=pageIndex + 1%>"><img src="<%=webapp %>/common/images/next.gif" alt="下一页" border="0"></a>
            <a href="<%=webapp %>/cotstatistics.do?method=queryRptByArea&queryAgain=false&pageIndex=<%=lastPageIndex-1%>"><img src="<%=webapp %>/common/images/last.gif" alt="最后页" border="0"></a>
            <%
          }
          else
          {
            ...
            %>
            <label>""<%=pageIndex+1%>/<%=lastPageIndex%>"page",</label>
            <label>""</label>
...
<div id="noData" style="display: none;position:absolute;"><H3>No data！<a href="#" onclick="javascript:window.close();">关闭</a></H3></div>
