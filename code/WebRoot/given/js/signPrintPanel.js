SignPrintPanel = function(cfg) {
	...
	var exportRpt = function() {
		...
		var rptUrl = cfg.exlAction+"?reportTemple=" + formData.reportTemple
	...
	Ext.apply(con, cfg);
	SignPrintPanel.superclass.constructor.call(this, con);
};
Ext.extend(SignPrintPanel, Ext.FormPanel, {});